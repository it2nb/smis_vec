...
class Teachrecord_class {
	...
	public function queryStudent(){
		return $this->student->queryBySql('Select * From student,teachstd Where student.student_ID=teachstd.student_ID and (student.student_endstatus=0 or student.student_endstatus=5) and teachstd.teach_ID='.$this->teach_ID);
	}
