...
<div class="noprint">
 ...
 ?>
  ...
  <tr>
    <td height="120" colspan="3" align="center" valign="middle" bgcolor="#CCCCCC" class="BlackBold10"><?php echo $scoregroup_fetch["scoregroup_name"];?></td>
    <td width="20" align="left" valign="bottom" bgcolor="#CCCCCC"><span class="verticaltext"><?php if($scoredetail_num>=$sdnum)echo mysql_result($scoredetail_query,($sdnum++)-1,"scoredetail_name");?></span></td>
    <td width="20" align="left" valign="bottom" bgcolor="#CCCCCC"><span class="verticaltext"><?php if($scoredetail_num>=$sdnum)echo mysql_result($scoredetail_query,($sdnum++)-1,"scoredetail_name");?></span></td>
    <td width="20" align="left" valign="bottom" bgcolor="#CCCCCC"><span class="verticaltext"><?php if($scoredetail_num>=$sdnum)echo mysql_result($scoredetail_query,($sdnum++)-1,"scoredetail_name");?></span></td>
    <td width="20" align="left" valign="bottom" bgcolor="#CCCCCC"><span class="verticaltext"><?php if($scoredetail_num>=$sdnum)echo mysql_result($scoredetail_query,($sdnum++)-1,"scoredetail_name");?></span></td>
    <td width="20" align="left" valign="bottom" bgcolor="#CCCCCC"><span class="verticaltext"><?php if($scoredetail_num>=$sdnum)echo mysql_result($scoredetail_query,($sdnum++)-1,"scoredetail_name");?></span></td>
    ...
    <td width="20" align="left" valign="bottom" bgcolor="#CCCCCC"><span class="verticaltext"><?php if($scoredetail_num>=$sdnum)echo mysql_result($scoredetail_query,($sdnum++)-1,"scoredetail_name");?></span></td>
    <td width="20" align="left" valign="bottom" bgcolor="#CCCCCC"><span class="verticaltext"><?php if($scoredetail_num>=$sdnum)echo mysql_result($scoredetail_query,($sdnum++)-1,"scoredetail_name");?></span></td>
    <td width="20" align="left" valign="bottom" bgcolor="#CCCCCC"><span class="verticaltext">รวม</span></td>
    <td width="20" align="left" valign="bottom" bgcolor="#CCCCCC"><span class="verticaltext"><b>รวมคะแนน</b></span></td>
  </tr>
  <tr>
    <td width="5%" align="center" valign="middle" bgcolor="#CCCCCC" class="BlackBold10">ลำดับ</td>
    <td width="15%" align="center" valign="middle" bgcolor="#CCCCCC" class="BlackBold10">รหัสประจำตัว</td>
    <td width="20%" align="center" valign="middle" bgcolor="#CCCCCC" class="BlackBold10">ชื่อ - สกุล</td>
    <td align="center" valign="middle" bgcolor="#CCCCCC"><?php if($scoredetail_num>=$sdnum2)echo mysql_result($scoredetail_query,($sdnum2++)-1,"scoredetail_score");?></td>
    <td align="center" valign="middle" bgcolor="#CCCCCC"><?php if($scoredetail_num>=$sdnum2)echo mysql_result($scoredetail_query,($sdnum2++)-1,"scoredetail_score");?></td>
    <td align="center" valign="middle" bgcolor="#CCCCCC"><?php if($scoredetail_num>=$sdnum2)echo mysql_result($scoredetail_query,($sdnum2++)-1,"scoredetail_score");?></td>
    <td align="center" valign="middle" bgcolor="#CCCCCC"><?php if($scoredetail_num>=$sdnum2)echo mysql_result($scoredetail_query,($sdnum2++)-1,"scoredetail_score");?></td>
    <td align="center" valign="middle" bgcolor="#CCCCCC"><?php if($scoredetail_num>=$sdnum2)echo mysql_result($scoredetail_query,($sdnum2++)-1,"scoredetail_score");?></td>
    ...
    <td align="center" valign="middle" bgcolor="#CCCCCC"><?php if($scoredetail_num>=$sdnum2)echo mysql_result($scoredetail_query,($sdnum2++)-1,"scoredetail_score");?></td>
    <td align="center" valign="middle" bgcolor="#CCCCCC"><?php if($scoredetail_num>=$sdnum2)echo mysql_result($scoredetail_query,($sdnum2++)-1,"scoredetail_score");?></td>
    <td align="center" valign="middle" bgcolor="#CCCCCC"><?php echo $sumscoredetail_fetch["sumscore"];?></td>
    <td align="center" valign="middle" bgcolor="#CCCCCC"><strong><?php echo $scoregroup_fetch["scoregroup_score"];?></strong></td>
  </tr>
  <?php
  while($r<=30&&$student_fetch=mysql_fetch_assoc($student_query))
  {
	  if($student_fetch["student_endstatus"]==0 || $student_fetch["student_endstatus"]==5){
		  $sdnum3=1;
		  $r++;
  ...
  <tr>
    ...
    <td align="center" valign="middle" bgcolor="#CCCCCC"><strong><?php echo round(($sumstdscore_fetch["sumscore"]*$scoregroup_fetch["scoregroup_score"])/$sumscoredetail_fetch["sumscore"],0);?></strong></td>
  </tr>
  <?php 
  }}
  while($r<=30)
