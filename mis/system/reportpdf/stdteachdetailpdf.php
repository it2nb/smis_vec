...
$query="Select major.*,area.* From teachstd,major,area,class Where teachstd.class_ID=class.class_ID and class.major_ID=major.major_ID and area.area_ID=major.area_ID and teach_ID='$teach_ID' and teachstd.class_ID='$class_ID' group by teachstd.class_ID";
