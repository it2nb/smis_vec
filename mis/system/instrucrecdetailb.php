  ...
  <center><br /><b>
	...
	?>
      <table width="80%" border="0" cellspacing="0" cellpadding="5">
        <tr>
          <td width="10" height="30" bgcolor="#FFCC33"><b><?php echo "สัปดาห์ที่ ".ceil($j/mysql_num_rows($teachday_query))." วัน".$thday[jddayofweek(gregoriantojd($rec_month,$rec_day,$rec_year),0)]." ที่ ".(int)$rec_day." ".$thmonth[(int)$rec_month]." ".((int)$rec_year+543);?></b></td>
        </tr>
        <tr>
          <td height="100" bgcolor="#DDDDDD">
