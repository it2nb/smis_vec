...
function addstdclass(id){
	$.get('addstdclass.php',{'class_ID':id},function(data){$('#systemcontent').html(data)});
}
function editstdparent(id){
	$.get('editstdparent.php',{'class_ID':id},function(data){$('#admincontent').html(data)});
}
</script>
    ...
    <tr>
    	<td align="left" valign="middle" width="128"><a href="#" onclick="addstdclass('<?php echo $class_ID;?>')"><img src="../images/icons/64/back.png" width="64" height="64" /></a><a href="index.php"><img src="../images/icons/64/home.png" width="64" height="64"></a></td>
        <td>&nbsp;</td>
    </tr>
    <tr bgcolor="#009999">
